...
const Header = () => {
    return (
        <div className="Header items-center px-8 mx-auto space-y-6 flex flex-col justify-between lg:flex-row md:container md:px-8 lg:space-x-16 lg:px-0">
            <div className='flex flex-col lg:w-1/2 lg:pt-16'>
                <h1 className='text-[46px] md:text-[56px] font-bold'>
                ...
                <div className="flex space-x-0 lg:w-l-12 flex-row mt-9">
                    <input 
                        type="text"
                ...
                <div className="flex flex-col space-y-1 mt-9 md:flex-row md:space-y-0 md:space-x-4">
                    ...
                    <p className='mx-auto md:text-[12px] md:pt-3'>
